...
@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/login']")WebElement loginpage;
@FindBy(xpath="/html/body/div/div[1]/section/div/div/div[1]/div/a")WebElement moreinfo;
@FindBy(xpath="/html/body/div/div[1]/section/div/div/div[3]/div/a")WebElement moreinfo1;
@FindBy(xpath="/html/body/div/div[1]/section/div/div/div[4]/div/a")WebElement subcategorymoreinfo;
