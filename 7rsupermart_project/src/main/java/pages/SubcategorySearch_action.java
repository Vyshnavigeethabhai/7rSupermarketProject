...
@FindBy(xpath="//select[@class='form-control selectpicker']")WebElement selectdropdown;
@FindBy(xpath="//option[text()='Vegetables']")WebElement categoryoption;
@FindBy(xpath="//input[@placeholder='Sub Category']")WebElement subcategoryname;
@FindBy(xpath="//button[@name='Search']")WebElement search;
@FindBy(xpath="//table/tbody/tr/td[1]")WebElement searchresult;
